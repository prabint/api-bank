...
class ApiBankSettingsPersistentStateComponent(project: Project) : PersistentStateComponent<ApiBankSettingsState> {
    ...
    companion object {
        fun getInstance(project: Project): ApiBankSettingsPersistentStateComponent = project.service()
    }
}
