...
class IdeaFrame(
    ...
    val notificationCenterPanel
        get() = find<ComponentFixture>(byXpath("//div[@class='NotificationCenterPanel']"), Duration.ofSeconds(5))

    val notification201Created
        get() = find<ComponentFixture>(
            byXpath("//div[@accessiblename='201 Created' and @class='JEditorPane']"),
